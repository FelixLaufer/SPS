...
public class DistributionCarriage extends LUnit implements Branching, Joining {

	public DistributionCarriage(PLC plc, int id, String name,
			ArrayList<Integer> IORows) {
